"""Identity resolver for the hospital-front-office example.
...
so the chat-binding tests stay hermetic.
"""
...
class HospitalIdentityResolver(OrchidIdentityResolver):
